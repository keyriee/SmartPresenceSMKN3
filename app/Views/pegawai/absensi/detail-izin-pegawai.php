                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                    ...
                                    <?php if ($detail_absensi->status_izin == 0) : ?>
                                        <a href="<?= base_url('pegawai/izinkan'); ?>/<?= $detail_absensi->kode_absensi; ?>/<?= $detail_absensi->pegawai; ?>" class="btn btn-success stripes-btn mt-3 btn-izinkan">Izinkan</a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer">
                            <a href="<?= base_url('pegawai/absen_admin'); ?>/<?= $detail_absensi->kode_absensi; ?>" class="btn btn-danger stripes-btn mt-3"><i class="icon-arrow-left"></i>Kembali</a>
                        </div>
                    </div>
