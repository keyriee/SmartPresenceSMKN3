                ...
                <ul class="header-actions">
                    ...
                    <li class="dropdown">
                        <a href="#" id="userSettings" class="user-settings" data-toggle="dropdown" aria-haspopup="true">
                            <span class="avatar">
                                <img src="<?= base_url(); ?>/assets/img/pegawai/<?= $pegawai2->gambar; ?>" alt="User Avatar">
                            </span>
                        </a>
        ...
        <div class="content-wrapper">
            ...
            <div class="row gutters">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <div class="card-body">
                            <a style="float: left" href="<?= base_url('pegawai/view_cetak2/' . $getPegawai . '/'.$getBulan.'/'.$getTahun) ?>" target="_blank" rel="" class="btn btn-success">Cetak</a>
                            <div class="d-flex justify-content-end">
                                <a href="<?= base_url('pegawai/absensi_admin'); ?>" class="btn btn-danger"><i class="icon-arrow-left"></i>Kembali</a>
                            </div>
                            <br>
                            <h5 class="card-title">DETAIL ABSENSI<span style="text-transform:uppercase"> <?= $bulan[$getBulan]; ?> <?= $getTahun; ?></span></h5>
                            <h5 class="card-title">NAMA PEGAWAI : <span style="text-transform:uppercase"><?= $pegawai->nama_pegawai ?></span></h5>
                            <h5 class="card-title">NIP PEGAWAI : <span style="text-transform:uppercase"><?= $pegawai->nip ?></span></h5>
                                            ...
                                            foreach ($detail_absensi as $absen) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="actions">
                                                            <?php if ($absen->izin == null && $absen->sakit == null && $absen->dinas_luar == null) : ?>
                                                                <a href="<?= base_url('pegawai/absen_pegawai_2'); ?>/<?= $absen->kode_absensi; ?>/<?= $absen->pegawai; ?>/<?= $getBulan ?>/<?= $getTahun ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                                                                    <i class="icon-external-link text-info"></i>
                                                                </a>
                                                            <?php elseif ($absen->izin != null) : ?>
                                                                <a href="<?= base_url('pegawai/izin_pegawai_2'); ?>/<?= $absen->kode_absensi; ?>/<?= $absen->pegawai; ?>/<?= $getBulan ?>/<?= $getTahun ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                                                                    <i class="icon-external-link text-info"></i>
                                                                </a>
                                                                <?php elseif ($absen->sakit != null) : ?>
                                                                <a href="<?= base_url('pegawai/sakit_pegawai_2'); ?>/<?= $absen->kode_absensi; ?>/<?= $absen->pegawai; ?>/<?= $getBulan ?>/<?= $getTahun ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                                                                    <i class="icon-external-link text-info"></i>
                                                                </a>
                                                                <?php elseif ($absen->dinas_luar != null) : ?>
                                                                <a href="<?= base_url('pegawai/dinas_luar_pegawai_2'); ?>/<?= $absen->kode_absensi; ?>/<?= $absen->pegawai; ?>/<?= $getBulan ?>/<?= $getTahun ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                                                                    <i class="icon-external-link text-info"></i>
                                                                </a>
                                                            <?php endif; ?>
                                                        </div>
