                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                    ...
                                    <?php if ($detail_absensi->status_dinas_luar == 0) : ?>
                                        <a href="<?= base_url('pegawai/setujuidinasluar'); ?>/<?= $detail_absensi->kode_absensi; ?>/<?= $detail_absensi->pegawai; ?>/<?= $bulan ?>/<?= $tahun ?>" class="btn btn-success stripes-btn mt-3 btn-izinkan">Setujui</a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
