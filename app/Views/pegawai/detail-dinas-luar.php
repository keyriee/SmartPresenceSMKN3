        ...
        <div class="content-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <?php if ($detail_absensi->dinas_luar == null) : ?>
                                <h5 class="card-title">
                                    Form Permohonan Dinas Luar Absensi
                                </h5>
                                <form action="<?= base_url('pegawai/dinas_luar'); ?>" method="post" enctype="multipart/form-data">
                                    <!-- Field wrapper start -->
                                    ...
                                    <div class="field-wrapper">
                                        ...
                                        <div class="field-placeholder">Keterangan <span class="text-danger">*</span></div>
                                        <div class="form-text">
                                            Tuliskan Keterangan Dinas Luar
                                        </div>
                                    </div>
                                    <!-- Field wrapper end -->
                                    ...
                                    <!-- Field wrapper start -->
                                    <div class="field-wrapper">
                                        <input class="form-control" type="file" name="bukti_dinas_luar" accept=".jpg, .jpeg, .png, .pdf, .doc" required>
                            ...
                            <?php else : ?>
                                <h5 class="card-title">
                                    Data Permohonan Dinas Luar Absensi
                                </h5>
                                ...
                                <div class="doc-block" style="padding: 13px;">
                                    ...
                                    <a href="<?= base_url('pegawai/download_izin'); ?>/<?= $detail_absensi->bukti_dinas_luar; ?>" class="btn btn-primary" target="_blank">Download</a>
                                </div>
