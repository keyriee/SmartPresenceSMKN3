                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <?php if ($absensi == null) : ?>
                                <a href="<?= base_url('pegawai/absen_hari_ini'); ?>" class="btn btn-primary stripes-btn absen-hari-ini">Absen Hari Ini</a>
                            <?php endif; ?>
                                    ...
                                    <tbody>
                                        ...
                                        if ($absensi != null) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="actions">
                                                        <a href="<?= base_url('pegawai/absen_admin'); ?>/<?= $absensi->kode_absensi; ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Detail">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr>
                            <form action="<?= base_url('pegawai/filter_absensi'); ?>" method="post">
                                <div class="row">
                                    <div class="col-md-2">
...
<script>
    function detailPegawai(id_pegawai) {
        ...
        window.location.href = "<?= base_url('pegawai/detail_pegawai?id='); ?>" + id_pegawai + "&bulan=" + bulan + "&tahun=" + tahun;
    }
