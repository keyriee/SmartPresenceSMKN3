        ...
        <div class="content-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <?php if ($detail_absensi->sakit == null) : ?>
                                <h5 class="card-title">
                                    Form Permohonan Sakit Absensi
                                </h5>
                                <form action="<?= base_url('pegawai/sakit'); ?>" method="post" enctype="multipart/form-data">
                                    <!-- Field wrapper start -->
                                    ...
                                    <!-- Field wrapper start -->
                                    <div class="field-wrapper">
                                        <input class="form-control" type="file" name="bukti_sakit" accept=".jpg, .jpeg, .png, .pdf, .doc" required>
