        ...
        <div class="content-wrapper">
            ...
            <div class="row gutters">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <div class="card-body">
                            <a style="float: left" href="<?= base_url('admin/view_cetak2/' . $getPegawai . '/'.$getBulan.'/'.$getTahun) ?>" target="_blank" rel="" class="btn btn-success">Cetak</a>
                                            ...
                                            foreach ($detail_absensi as $absen) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="actions">
                                                            <?php if ($absen->izin == null && $absen->sakit == null && $absen->dinas_luar == null) : ?>
                                                                <a href="<?= base_url('admin/absen_pegawai_2'); ?>/<?= $absen->kode_absensi; ?>/<?= $absen->pegawai; ?>/<?= $getBulan ?>/<?= $getTahun ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                                                                    <i class="icon-external-link text-info"></i>
                                                                </a>
                                                            <?php elseif ($absen->izin != null) : ?>
                                                                <a href="<?= base_url('admin/izin_pegawai_2'); ?>/<?= $absen->kode_absensi; ?>/<?= $absen->pegawai; ?>/<?= $getBulan ?>/<?= $getTahun ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                                                                    <i class="icon-external-link text-info"></i>
                                                                </a>
                                                                <?php elseif ($absen->sakit != null) : ?>
                                                                <a href="<?= base_url('admin/sakit_pegawai_2'); ?>/<?= $absen->kode_absensi; ?>/<?= $absen->pegawai; ?>/<?= $getBulan ?>/<?= $getTahun ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                                                                    <i class="icon-external-link text-info"></i>
                                                                </a>
                                                                <?php elseif ($absen->dinas_luar != null) : ?>
                                                                <a href="<?= base_url('admin/dinas_luar_pegawai_2'); ?>/<?= $absen->kode_absensi; ?>/<?= $absen->pegawai; ?>/<?= $getBulan ?>/<?= $getTahun ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                                                                    <i class="icon-external-link text-info"></i>
                                                                </a>
                                                            <?php endif; ?>
                                                        </div>
